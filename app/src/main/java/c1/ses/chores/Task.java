...
public class Task {
    ...
    private Boolean completed = false; // Whether or not task is done, starts off as incomplete.
    ...
    public Task(String id, String title, String details, Double compensation, Date reqDate) {
